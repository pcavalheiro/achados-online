/**
 * Single source for Amazon affiliate destinations (/go/[key]).
 * Update URLs here only.
 */
...
export function getAffiliateUrl(key: string): string | undefined {
  return AFFILIATE_LINKS[key as AffiliateKey];
}
